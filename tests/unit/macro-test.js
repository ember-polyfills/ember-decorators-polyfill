...
module('macros', function() {
  ...
  test('@collect', function(assert) {
    ...
    assert.deepEqual(get(obj, 'taco').toArray(), [
      'cheese',
      'beef',
      'tortilla',
    ]);
  ...
  test('@map', function(assert) {
    ...
    assert.deepEqual(get(obj, 'loudNames').toArray(), [
      'ONE!',
      'TWO!',
      'THREE!',
    ]);
  ...
  test('@sort', function(assert) {
    ...
    assert.deepEqual(get(obj, 'sortedNames').mapBy('name'), [
      'a',
      'b',
      'foo',
      'z',
  ...
  test('@union', function(assert) {
    ...
    assert.deepEqual(get(obj, 'unionNames').toArray(), [
      'one',
      'two',
      'three',
      'twenty',
  ...
  test('@uniqBy', function(assert) {
    ...
    assert.deepEqual(get(obj, 'oneOfEachColor').toArray(), [
      { name: 'banana', color: 'yellow' },
      { name: 'apple', color: 'red' },
      { name: 'kiwi', color: 'brown' },
    ]);
